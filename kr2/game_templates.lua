-- chunkname: @./kr2/game_templates.lua
...
local scripts1 = require("game_scripts_1")
...
tt.main_script.update = scripts1.tower_ranger.update
tt.attacks.range = 200
...
tt.main_script.update = script1s.aura_ranger_thorn.update
...
tt.render.sprites[4] = table.deepclone(tt.render.sprites[3])
tt.render.sprites[4].offset.x = 8
tt.main_script.update = scripts1.tower_musketeer.update
...
tt.main_script.insert = scripts1.mod_hps.insert
tt.main_script.update = scripts1.mod_hps.update
...
tt.motion.max_speed = 75
tt.powers.dual = E:clone_c("power")
tt.powers.dual.on_power_upgrade = scripts1.soldier_barbarian.on_power_upgrade
tt.powers.twister = E:clone_c("power")
tt.powers.throwing = E:clone_c("power")
tt.regen.health = 20
...
tt.main_script.insert = scripts1.axe_barbarian.insert
...
tt.info.enc_icon = 20
tt.info.portrait = (IS_PHONE and "portraits_towers" or "info_portraits_towers") .. "_0005"
...
tt.info.enc_icon = 19
tt.info.portrait = (IS_PHONE and "portraits_towers" or "info_portraits_towers") .. "_0006"
